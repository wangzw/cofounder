...
| `leaves-manifest.yml` | `scripts/snapshot-leaves.sh` (review/index.md Step 1.5) | sha256 of every design leaf at the start of the read phase. Survives compaction (final round only) and feeds the next round's incremental-scope diff. |
