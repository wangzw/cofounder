...
#
# This concept recurses: if system-design ever generates a sub-skill, the
# sub-skill's scaffold-provenance.yml records system-design's version (since
# system-design owns scaffold.sh in that case). The same logic applies.
#
