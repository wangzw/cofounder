...
- **Do not Write, Edit, or NotebookEdit any file under `~/.claude/skills/`
  ...
  prior session (2026-05-15) appended 102 lines to a sibling skill's
  catalog before the user noticed and reverted. If you believe a
  recurring adversarial pattern deserves promotion to a registered CR,
  that is the orchestrator's criteria-evolution job, not yours.
