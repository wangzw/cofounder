...
# FAIL ACK pattern across both copies (main + the document skeleton).
set -euo pipefail
...
# Test 2: document skeleton
check_file "$ROOT/common/skeleton/document/revise/per-issue-reviser-subagent.md" "skeleton/document"

# Test 3: skill-forge adversarial-reviewer attack angle #6 still references
...
echo "=== PASS test-reviser-global-conflict.sh (3 sub-tests) ==="
