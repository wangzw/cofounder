...
| `review-scope.yml` | `scripts/compute-review-scope.sh` (review/index.md Step 1.6) | `mode: full \| incremental`, `reason`, `changed_leaves[]`, `unchanged_leaves[]`. Reviewers consume this file to decide which LLM criteria apply to which leaves. |
