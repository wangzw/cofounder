...
category: traceability         # Required (since v1.4). One of the categories in common/criterion-categories.md. Auto-derived from criterion_id by create-issues.sh.
