...
# Since the final tag is always `prd-analysis-delivery-<N>-<slug>`, strip a leading
# redundant `delivery <N>:` / `delivery-<N>:` / `Delivery <N>:` /
# `prd-analysis-delivery-<N>:` (or any `<skill>-delivery-<N>:`) prefix from the
# summary before slug computation. Prevents tags like
# `prd-analysis-delivery-2-prd-analysis-delivery-2-...` when summarizer's
...
TAG="prd-analysis-delivery-${DELIVERY_ID}-${SLUG}"
