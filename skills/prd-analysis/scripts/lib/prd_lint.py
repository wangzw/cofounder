"""prd_lint — shared utilities for prd-analysis formal-review scripts.
...
Usage from a check-*.sh script:
    ...
    from prd_lint import Finding, parse_frontmatter, emit, walk_md, ROUND_RE
...
# blocks, no list items). Adequate for the schemas prd-analysis defines.
