...
id: I-002
criterion_id: CR-PP12
file: features/F-002.md
severity: error
state: new
created_in_round: 2
history: []
...
'
assert_exit 0 "$MIGRATE" "$FIXTURE"
grep -q "^category: traceability$" "$FIXTURE/.review/round-1/issues/I-001.md" && _record_pass || _record_fail "round-1 issue not migrated"
grep -q "^category: coherence$" "$FIXTURE/.review/round-2/issues/I-002.md" && _record_pass || _record_fail "round-2 issue not migrated"
teardown_fixture
