...
Generate a prd-analysis skill that helps founders and small teams turn product ideas or brainstorming notes into structured, AI-coding-ready PRDs (multi-file directory output, self-contained feature/journey/architecture files). Use @skills/prd-analysis.backup as the baseline reference for what the skill should look like.
