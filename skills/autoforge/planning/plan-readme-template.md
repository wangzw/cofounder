...
| Current Design Delivery | `system-design-delivery-{N}-{slug}` (matches the design's most recent `system-design-delivery-*` annotated tag at last autoforge run) |
...
|----------|------|--------------------|--------------------|---------------|-------------------------------------------|--------------------|---------|
| 1 | {YYYY-MM-DD} | — | `system-design-delivery-1-{slug}` | `autoforge-delivery-1-{slug}` | — / {n} / — / — | {PASS\|PARTIAL\|FAIL} | Initial implementation |
| 2 | {YYYY-MM-DD} | `system-design-delivery-1-{slug}` | `system-design-delivery-2-{slug}` | `autoforge-delivery-2-{slug}` | {r} / {a} / {d} / {k} | {verdict} | See [`versions/2.md`](versions/2.md) |
